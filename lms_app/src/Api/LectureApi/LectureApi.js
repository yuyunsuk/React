...
export async function getAllLecture(search = "", category = "") {
    try {
        ...
        const response = await api.get(
            `/api/lecture?${queryParams.toString()}`
        );
...
export async function getCategoryLecture(keyword) {
    try {
        const response = await api.get(`/api/lecture/category/${keyword}`);
        return response.data;
    } catch (error) {
...
export async function getLecture(lectureId) {
    try {
        const response = await api.get(`/api/lecture/${lectureId}`);
        return response.data;
    } catch (error) {
...
export async function getLectureCategoryCountJPQL() {
    try {
        const response = await api.get("/api/lecture/categoryCount");
        return response.data;
    } catch (error) {
