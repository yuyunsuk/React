...
export function Notices() {
  ...
  const checkLoginStatus = async () => {
    try {
      ...
      if (user && user.userId) {
        const isAdminUser =
          user.authority && user.authority.authorityName === "ROLE_ADMIN";
            ...
            {selectedNotice ? (
              <NoticeDetail>
                ...
                {isAdmin && (
                  <DeleteButton
                    onClick={() =>
                      deleteSelectedNotice(selectedNotice.lmsNoticesSeq)
                    }
                  >
                    삭제
                  </DeleteButton>
                    ...
                    {notices.map((notice, index) => (
                      <tr key={notice.lmsNoticesSeq}>
                        ...
                        <TableData
                          ...
                          onClick={() =>
                            loadNoticeDetails(notice.lmsNoticesSeq)
                          }
                        >
                          {notice.lmsNoticesTitle}
                        </TableData>
                        <TableData>
                          {notice.user ? notice.user.userNameKor : "관리자"}
                        </TableData>
                        <TableData>
                          {new Date(
